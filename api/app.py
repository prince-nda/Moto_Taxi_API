...
if __name__ == '__main__':
    ...
    print('\nAvailable endpoints:')
    print('  GET /                     - Root endpoint (no auth)')
    print('  GET /health               - Health check (no auth)')
    print('  GET /openapi.json         - OpenAPI spec in JSON (no auth)')
    print('  GET /openapi.yaml         - OpenAPI spec in YAML (no auth)')
    print('  GET /riders               - List all riders (requires auth)')
    print('  GET /riders/available     - List available riders (requires auth)')
    print('  GET /riders/{id}          - Get specific rider (requires auth)')
